...
export default function HomePage() {
  const [tables, setTables] = useState<Table[]>([
    ...
    T("20", 4, 150, 130, 78, 42),
    T("21", 4, 235, 130, 78, 42),
    ...
    T("San Miguel 1", 12, 1165, 320, 145, 58),
    T("San Miguel 2", 12, 1165, 445, 145, 58),
  ]);
      ...
      <div style={{ width: "100%", overflowX: "auto" }}>
        ...
        >
          ...
          >
            ...
            <div style={{ height: 470, padding: 12, fontSize: 17 }}>
              GUEST NAME:<br /><br />
              ARRIVAL TIME:<br /><br />
              GUESTS:<br /><br />
              SERVER:
          ...
          <div style={{ position: "absolute", left: 335, top: 315, width: 245, height: 6, background: "#111827", zIndex: 1 }} />
          ...
          <div style={{ position: "absolute", left: 220, top: 790, width: 8, height: 235, background: "#111827", zIndex: 1 }} />
          ...
          <div style={{ position: "absolute", left: 300, top: 625, width: 330, height: 85, borderRadius: 20, border: "5px solid #64748b", background: "#dbeafe", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 34, fontWeight: "bold", zIndex: 2 }}>
            BAR
          </div>

          <div style={{ position: "absolute", left: 780, top: 560, width: 270, height: 55, background: "white", border: "3px solid #111827", textAlign: "center", paddingTop: 8, fontWeight: "bold", zIndex: 2 }}>
            Buffet
          </div>

          <div style={{ position: "absolute", left: 810, top: 675, width: 220, height: 45, background: "#dbeafe", border: "1px solid #64748b", textAlign: "center", paddingTop: 8, fontSize: 13, zIndex: 2 }}>
          ...
          {tables.map((table, index) => (
            <button
              ...
              style={{
                ...
                border: table.status === "Boxed" ? "4px solid #f59e0b" : "2px solid #334155",
                borderRadius: 8,
                color: "#006ee6",
                fontWeight: "bold",
                fontSize: 10,
            ...
            >
              {table.id}<br />
              {table.seats > 0 ? table.seats : "Couch"}<br />
